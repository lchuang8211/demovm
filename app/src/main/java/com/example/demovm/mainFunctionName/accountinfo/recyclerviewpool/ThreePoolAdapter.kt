...
class ThreePoolAdapter : RecyclerView.Adapter<ThreePoolViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ThreePoolViewHolder {
        Log.i(TAG, "onCreateViewHolder: ")
        return ThreePoolViewHolder.from( parent )
    }
    ...
    override fun onBindViewHolder(holder: ThreePoolViewHolder, position: Int) {
        Log.i(TAG, "onBindViewHolder: ")
        //多型應用 對應相應Class取得對應資料
        if (holder is ThreePoolViewHolder){
