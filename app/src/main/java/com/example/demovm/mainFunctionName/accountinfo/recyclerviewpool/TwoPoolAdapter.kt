...
class TwoPoolAdapter: RecyclerView.Adapter<TwoPoolViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TwoPoolViewHolder {
        Log.i(TAG, "onCreateViewHolder: ")
        return TwoPoolViewHolder.from( parent )
    }
    ...
    override fun onBindViewHolder(holder: TwoPoolViewHolder, position: Int) {
        Log.i(TAG, "onBindViewHolder: ")
        //多型應用 對應相應Class取得對應資料
        if (holder is TwoPoolViewHolder){
